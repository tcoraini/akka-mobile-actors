...
trait SuspendedRequest extends ContinuationListener
                       with Logging
{
  ...
  var context: Option[AsyncContext] = None

  def init(suspend:()=>Option[AsyncContext], callback:()=>Option[ContinuationListener]) =
  {
    suspend() match
    {
  ...
  def onTimeout(c:Continuation) =
    {
        ...
        //
      c.getServletResponse.asInstanceOf[HttpServletResponse].addHeader("Suspend","Expired")
      c.complete
...
case class Delete(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Get(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Head(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Options(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Post(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Put(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
case class Trace(f:(()=>Option[AsyncContext]), g:(()=>Option[ContinuationListener])) extends SuspendedRequest {init(f, g)}
